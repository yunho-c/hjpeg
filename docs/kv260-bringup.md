...
- The JSON evidence records artifact/report paths, byte lengths, SHA-256
  ...
  structured JSON failures. Timing thresholds, utilization threshold, and target
  clock period values must be finite. The target clock period must be positive,
