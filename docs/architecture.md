...
definitions, rejects empty, oversized, or oversubscribed DHT tables and dangling
table references, requires the encoder's baseline marker order of optional
