...
tables and dangling table references, requires the encoder's baseline marker
...
and requires the SOF0 sampling factors to match the supported 4:4:4 or 4:2:0
modes. The helper
