...
count and match the per-category pass/fail totals, well-formed SHA-256 hex
hashes on passing records in every required evidence category, and a passing route-status
