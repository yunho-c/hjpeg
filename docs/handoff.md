...
exactly, requires SOF0/SOS component IDs in `[1, 2, 3]` order, requires SOS
table selectors to be Y `0/0` and Cb/Cr `1/1`, requires baseline SOS spectral
fields `0/63/0`, records SOF0 component sampling factors and MCU count, requires
