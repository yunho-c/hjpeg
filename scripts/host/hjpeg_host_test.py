...
class HjpegHostTest(unittest.TestCase):
    ...
    def test_check_run_evidence_file_reports_complete_summary(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(record["recorded_check_count"], 104)
            self.assertEqual(record["passing_check_count"], 104)
            self.assertEqual(
    ...
    def test_check_run_evidence_file_reports_failing_checks(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(record["recorded_check_count"], 104)
            self.assertEqual(record["passing_check_count"], 103)
            self.assertEqual(
                record["passing_checks"],
                [
                    name
    ...
    def test_check_run_evidence_file_rejects_scan_data_length_mismatch(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(record["recorded_check_count"], 104)
            self.assertEqual(record["passing_check_count"], 102)
    ...
    def test_check_run_evidence_cli_can_print_json_failures(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(record["aggregate_recorded_check_count"], 115)
            self.assertEqual(record["aggregate_passing_check_count"], 104)
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(
                record["hardware_run_summary"],
                {
                    ...
                    "recorded_check_count": 104,
                    "passing_check_count": 104,
