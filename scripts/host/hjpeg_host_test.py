...
class HjpegHostTest(unittest.TestCase):
    ...
    def test_hardware_summary_requires_distinct_stream_devices(self) -> None:
        ...
        complete = {
            "stream_devices": {
                "tx_device": "tx.dev",
                "rx_device": "rx.dev",
                "tx_device_resolved": "/dev/hjpeg-mm2s",
                "rx_device_resolved": "/dev/hjpeg-s2mm",
            }
        }
    ...
    def test_hardware_summary_requires_output_hash_and_scan_evidence(self) -> None:
        ...
        self.assertFalse(summary["all_recorded_checks_passed"])
        self.assertEqual(summary["recorded_check_count"], 11)
        self.assertEqual(
    ...
    def test_check_run_evidence_file_reports_complete_summary(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(record["recorded_check_count"], 108)
            self.assertEqual(record["passing_check_count"], 108)
            self.assertEqual(
    ...
    def test_check_run_evidence_file_reports_incomplete_summary(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(record["recorded_check_count"], 79)
            self.assertEqual(record["passing_check_count"], 79)
            self.assertEqual(
                record["passing_checks"],
                list(evidence["hardware_run_summary"]["checks"].keys()),
            )
    ...
    def test_check_run_evidence_file_reports_failing_checks(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(record["recorded_check_count"], 108)
            self.assertEqual(record["passing_check_count"], 107)
            self.assertEqual(
                record["passing_checks"],
                [
                    name
    ...
    def test_check_run_evidence_file_rejects_scan_data_length_mismatch(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(record["recorded_check_count"], 108)
            self.assertEqual(record["passing_check_count"], 106)
    ...
    def test_check_run_evidence_cli_can_print_json_failures(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(record["aggregate_recorded_check_count"], 119)
            self.assertEqual(record["aggregate_passing_check_count"], 108)
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(
                record["hardware_run_summary"],
                {
                    ...
                    "recorded_check_count": 108,
                    "passing_check_count": 108,
