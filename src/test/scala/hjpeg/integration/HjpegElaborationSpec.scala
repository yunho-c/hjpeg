...
class HjpegElaborationSpec extends AnyFreeSpec with Matchers {
  "Hjpeg top levels should elaborate" in {
    ...
    ChiselStage.emitSystemVerilog(new PipelinedDct8x8Stage()) must include("module PipelinedDct8x8Stage")
    ...
    ChiselStage.emitSystemVerilog(new JpegParallelMcuEntropyStage()) must include("module JpegParallelMcuEntropyStage")
