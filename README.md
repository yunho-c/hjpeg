...
required records to carry nonempty file metadata and SHA-256 hashes, and the
...
include nonempty TX/RX device paths, their resolved identities, and distinct
raw and resolved endpoints. Capture configuration evidence
...
rates, aggregate JPEG/input artifact path and decoder-command inventories, Vivado
