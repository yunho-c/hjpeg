...
passing, and failing check counts, missing evidence group names, and the names
of failing checks for review.
...
output includes aggregate checked/pass/fail counts and passed/failed path lists
