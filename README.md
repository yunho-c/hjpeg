...
non-baseline SOS spectral fields, unsupported header markers, non-JFIF or
duplicate APP0 markers, unexpected non-RST/non-EOI markers after SOS,
nonstandard DQT/DHT table sets or segment counts, duplicate DQT/DHT table
definitions, non-8-bit DQT tables, zero-valued DQT entries, empty, oversized,
oversubscribed, or invalid baseline DHT tables, RST markers without DRI, RST
