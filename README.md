...
checked report/artifact count, per-category checked counts, and pass/fail state
in machine-readable build evidence. Missing, non-file, or unparseable reports
